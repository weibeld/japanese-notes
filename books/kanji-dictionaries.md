...
- Readings in romaji
- Includes compounds with the kanji at any position

❌ Cons:

- Doesn't include stroke order or any other information about the kanji
...
- German translation of [Japanese Character Dictionary: With Compound Look-up via Any Kanji](#japanese-character-dictionary-with-compound-look-up-via-any-kanji)
...
- **Scripts:** words and compounds in kanji, kana, and romaji, however, kana is always hiragana, even for on-yomi readings
...
- Uses the 214 Kangxi radicals in contrast to the other Kodansha kanji dictionaries
- In the compound entries, on-yomi compunds and kun-yomi compounds are listed separately
...
- On-yomi and kun-yomi are not listed together at the head of the entries, but buried in the compound listings
- No single keyword translation for each kanji (only translations of compounds)
- For some kanji, includes a specially marked section with business terms, which is not really necessary
